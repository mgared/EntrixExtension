...
// ─────────────────────────────────────────────────────────────────────
// SITE PROFILE — the VIA build.
//
// VIA runs the desk exactly as Benjamin does: same twelve roles, same
// reasons, the loading dock included. The only thing that differs between
// the two builds is SITE_NAME and the walk route below — VIA has more
// amenities and they are spread over more floors.
//
// Against the ORA build it also drops the parking role, ORA's desk being
// the only one with a parking company to deal with.
// ─────────────────────────────────────────────────────────────────────
...
export const MANUAL_URL =
  "https://claude.ai/code/artifact/77ec2f86-9a66-4479-bb5c-76a354f44b7c";

// Building, policies, contacts. Opened by the Site info button.
export const SITE_INFO_URL =
  "https://claude.ai/code/artifact/dc8e5119-b092-4233-a797-727231db5dad";
...
export const SITE_TOUR_AREAS = [
  ...
  { id: "terrace4", floor: "4th floor", label: "Outside terrace" },
  { id: "fireplace", floor: "4th floor", label: "Fire place" },

  // Two rooms of the same name on different floors. The ids keep them
  // apart, and the floor heading above each row tells the walker which
  // one they are ticking.
  { id: "innovation6", floor: "6th floor", label: "Innovation room" },

  { id: "innovation8", floor: "8th floor", label: "Innovation room" },

  { id: "skyView9", floor: "9th floor", label: "Sky View terrace" },
